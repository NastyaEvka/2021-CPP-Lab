...
//Имеется кучка из N камней. Каждый игрок по очереди берёт 1, 2
//или 3 камня.Выигрывает тот, кто оставляет последний камень
//сопернику.Запрограммировать:
//1. Игру двух людей между собой.
...
char chooseMode()
{
    while (true)
    {
        ...
        if (operation == '1' || operation == '2')
            ...
            cout << "Такого режима нет, введите 1 или 2.\n";
    }
}
